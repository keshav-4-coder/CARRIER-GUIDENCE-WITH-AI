import{t as e}from"./circle-alert-DLOqE4Q8.js";import{t}from"./lock-CTMrtEx_.js";import{t as n}from"./mail-BuUqOLKC.js";import{_ as r,f as i,g as a,m as o,s,u as c,v as l}from"./index-CmeRcj-x.js";var u=l(r()),d=l(i()),f=`http://localhost:8000/api`;function p(){let r=a(),[i,l]=(0,u.useState)({email:``,password:``}),[p,m]=(0,u.useState)(``),[h,g]=(0,u.useState)(!1);(0,u.useEffect)(()=>{console.log(`Login component mounted`);let e=document.createElement(`style`);return e.textContent=`
      .auth-container {
